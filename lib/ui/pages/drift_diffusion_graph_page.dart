  ...
  List<Widget> _buildControlsChildren(
    ...
    return [
      ...
      ParameterSlider(
        ...
        subtitle: _useCmUnits ? r'$\mathrm{cm}^{-3}$' : r'$\mathrm{m}^{-3}$',
      ),
      ParameterSlider(
        ...
        subtitle: r'Controls $\mathrm{d}n/\mathrm{d}x$ magnitude',
      ),
      ParameterSlider(
        label: r'$\mu$ ($\mathrm{cm}^{2}\,\mathrm{V}^{-1}\,\mathrm{s}^{-1}$)',
        value: _mobilityCm2,
      ...
      ParameterSegmented<bool>(
        ...
        segments: const [
          ButtonSegment(
            value: true,
            label: LatexText(r'\mathrm{cm}^{-3}', scale: 0.95),
          ),
          ButtonSegment(
            value: false,
            label: LatexText(r'\mathrm{m}^{-3}', scale: 0.95),
          ),
        ],
      ...
      if (!_useEinstein)
        ParameterSlider(
          label: r'$D$ override ($\mathrm{m}^{2}\,\mathrm{s}^{-1}$)',
          value: _manualD,
          min: 1e-4,
          max: 0.05,
          onChanged: (v) {
